...
export const resolvers = {
  Query: {
    // READ ALL
    allTasks: async (root: any, { userId }: { userId: string }) => {
      // root es la informacion previa. Es literalmente la informacion o el objeto que se retorna al hacer la query anterior.
